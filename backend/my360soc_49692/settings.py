"""
Django settings for my360soc_49692 project.
...
ROOT_URLCONF = 'my360soc_49692.urls'
...
WSGI_APPLICATION = 'my360soc_49692.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "my360soc Support <support@my360soc-49692.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my360soc_49692 API",
    "DESCRIPTION": "API documentation for my360soc_49692 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "my360soc_49692.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "my360soc_49692.storage_backends.AzureStaticStorage"
